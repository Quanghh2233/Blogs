...
const docTemplate = `{
    ...
    "info": {
        ...
        "title": "{{.Title}}",
        "contact": {
            "name": "Hoàng Huy Quang",
            "email": "quanghoanghuy33@gmail.com"
        },
        "license": {
            "name": "Apache 2.0",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/serializer.CategoryResp"
                        }
                    }
                }
            },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/serializer.PostResp"
                        }
                    }
                }
            },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/serializer.CommentResp"
                        }
                    }
                }
            },
